...
"""
/***************************************************************************
 Permite cargar las parcelas y los recintos del sigpac, mediante la introduccion del municipio, poligono y parcela.
 Tambien mediante la introduccion de una coordenada.
...
class Sigpac:
    ...
    def add_action(
        ...
        icon_path=os.path.join(r"C:\Users",usuario,r"AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\sigpac\icon.png")
