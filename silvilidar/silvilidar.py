    ...
    def run(self):
        ...
        def exprimelidar(las, carpeta, crecimiento, fccbaja, fccterrazas, fccmedia, fccalta, hmontebravoe, hmontebravo,
            ...
            def agregado(rasterdeentrada, filtro):
                ...
                params = {'INPUT': input, 'DISTANCE': 100, 'BAND': 1, 'ITERATIONS': 0, 'NO_MASK': False,
                          'OUTPUT': output}
                ...
                StringToRaster(os.path.join(carpeta, troncoresumido + '_' + rasterdeentrada + '1n.tif'),
                               rasterdeentrada + str("1n"))
                ...
                parameters = {'INPUT': os.path.join(carpeta, troncoresumido + '_' + rasterdeentrada + '7.tif'),
