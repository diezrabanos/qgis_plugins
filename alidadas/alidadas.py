...
/***************************************************************************
 Alidadas
                                 A QGIS plugin
 Hace el cruce de visuales desde varias torretas, desde 1 hasta 4. Dibuja la visual desde cada torreta, hace cada una de las combinaciones
 y calcula cada punto de cruce. Finalmente selecciona el mejor cruce posible minimizando el error a partir del angulo de cruce y la 
 distancia.
