...
#miro la distancia nucleos urbanos
    ...
    def hagomapa(self,carpetasalida,tipo,nombre,resultado1,resultado2,resultado3,escala):#basado en hagomapa3 del complemento informes resultado1=capa sigmena valladolid, resultado2=bic, resultado3=nucleos urbanos, escala=escala del mapa a sacar
        ...
        c.setFont("Helvetica-Bold", 10)
        #aqui meto un texto 
        ptext =  "Decreto Ley 2/2022 de 23 de junio por el que se adoptan medidas urgentes para la agilización" 
        ...
        if tipo=='FOTOVOLTAICA':        
            ptext =  "Artículo13, 2a), Terrenos incluidos en la Red de Áreas Naturales Protegidas................."+texto
        if tipo=='EÓLICA':
            ptext =  "Artículo13, 1a), Terrenos incluidos en la RANP,salvo protectores y de UP......................"+texto
        ...
        if len(resultado2)==0:
            ...
            texto='SÍ'
        if tipo=='FOTOVOLTAICA':
            ptext =  "Artículo13, 2d), Terrenos ubicados a menos de 500 metros de un B.I.C.........................."+texto
        if tipo=='EÓLICA':
            ptext =  "Artículo13, 1c), Terrenos ubicados a menos de 500 metros de un B.I.C.........................."+texto
        c.drawString(40*mm, ytexto*mm, ptext)
        ...
        if len(resultado3)==0:
            ...
            texto='SÍ'
        if tipo=='FOTOVOLTAICA':
            ptext =  "Artículo13, 2e), Parcelas ubicadas a menos de 500 metros de los núcleos urbanos......."+texto
        if tipo=='EÓLICA':
            ptext =  "Artículo13, 1d), Parcelas ubicadas a menos de 1000 metros de los núcleos urbanos......"+texto
        c.drawString(40*mm, ytexto*mm, ptext)
