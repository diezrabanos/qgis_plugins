...
puntosSigmena
                                 A QGIS plugin
Permite crear un punto en unas coordenadas introduciodas dentro de una capa preexistente y abre el formulario
...
from .puntosSigmena_dialog import PuntosSigmenaDialog
import os.path
...
class PuntosSigmena:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PuntosSigmena', message)
    ...
    def add_action(
        ...
        icon_path=os.path.join(usuario,r"python\plugins\puntosSigmena\icon.png")
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/puntosSigmena/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'PuntosSigmena'),
            callback=self.run,
