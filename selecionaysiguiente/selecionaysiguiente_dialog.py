...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'selecionaysiguiente_dialog_base.ui'))


class selecionaysiguienteDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(selecionaysiguienteDialog, self).__init__(parent)
