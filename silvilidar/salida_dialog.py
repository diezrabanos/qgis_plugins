...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'salida_dialog_base.ui'))



class SalidaDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(SalidaDialog, self).__init__(parent)

        print("llega al salida dialog")
